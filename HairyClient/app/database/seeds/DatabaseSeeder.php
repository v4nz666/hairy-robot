...
class SpacePartTableSeeder extends Seeder {
  public function run() {
    SpacePart::create(['name' => 'Hull', 'desc' => 'A 16x16m&sup2; section of hull', 'mass' => 1, 'render' => 'ctx.fillStyle=\'white\';ctx.strokeStyle=\'grey\';ctx.beginPath();ctx.moveTo(0,0);ctx.lineTo(0,16);ctx.lineTo(16,16);ctx.lineTo(16,0);ctx.closePath();ctx.fill();ctx.stroke();', 'cost' => 1000]);
  }
}